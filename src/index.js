...
document.addEventListener('DOMContentLoaded', () => {
  ...
  jkLoadForm.addEventListener('submit', async e => {
    ...
    document.title = `${defaultTitle} - ${jkLoadForm.channelPicker.options[jkLoadForm.channelPicker.selectedIndex].text} ${jkLoadForm._date.value.replaceAll('-','/')} ${jkLoadForm.timeStart.value} - ${jkLoadForm.timeEnd.value}`;
    const params = new URLSearchParams(location.search);
